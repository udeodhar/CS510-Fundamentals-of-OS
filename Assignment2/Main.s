...
! SEND STATEMENT...
	...
	mov	"\0\0SE",r10
!   _temp_313 = &_Global_full_buffs
	set	_Global_full_buffs,r1
	store	r1,[r14+-224]
...
! SEND STATEMENT...
	...
	mov	"\0\0SE",r10
!   _temp_314 = &_Global_empty_buffs
	set	_Global_empty_buffs,r1
	store	r1,[r14+-220]
...
! SEND STATEMENT...
	...
	mov	"\0\0SE",r10
!   _temp_315 = &_Global_lockIn
	set	_Global_lockIn,r1
	store	r1,[r14+-216]
!   Send message Init
	load	[r14+-216],r1
	load	[r1],r2
...
! SEND STATEMENT...
	...
	mov	"\0\0SE",r10
!   _temp_316 = &_Global_lockOut
	set	_Global_lockOut,r1
	store	r1,[r14+-212]
!   Send message Init
	load	[r14+-212],r1
	load	[r1],r2
...
! SEND STATEMENT...
	...
	mov	"\0\0SE",r10
!   _temp_317 = &_Global_lockPrint
	set	_Global_lockPrint,r1
	store	r1,[r14+-208]
!   Send message Init
	load	[r14+-208],r1
	load	[r1],r2
...
_P_Main_ForkMonitor:
	...
	jmp	_Method_P_Main_ForkMonitor_3	! 8:	Test
	jmp	_Method_P_Main_ForkMonitor_2	! 12:	PickupForks
...
!   Next value...
	...
	store	r1,[r14+-156]
_Label_614:
!   Data Move: *_temp_612 = 3  (sizeInBytes=4)
	mov	3,r1
	load	[r14+-160],r2
	store	r1,[r2]
!   _temp_612 = _temp_612 + 4
...
!   Next value...
!   NEW CLASS Constructor...
!   ZeroMemory: _temp_620 = zeros  (sizeInBytes=16)
	add	r14,-52,r4
	store	r0,[r4]
	store	r0,[r4+4]
	store	r0,[r4+8]
	store	r0,[r4+12]
!   _temp_620 = _P_Synch_Condition
	set	_P_Synch_Condition,r1
	store	r1,[r14+-52]
	mov	5,r1
	store	r1,[r14+-56]
_Label_622:
!   Data Move: *_temp_618 = _temp_620  (sizeInBytes=16)
	add	r14,-52,r5
	load	[r14+-60],r4
	load	[r5],r1
	store	r1,[r4]
...
!   _temp_619 = _temp_619 + -1
	...
	add	r1,-1,r1
	store	r1,[r14+-56]
!   if intNotZero (_temp_619) then goto _Label_622
	load	[r14+-56],r1
	cmp	r1,r0
	bne	_Label_622
!   Initialize the array size...
...
!   make sure array has size 5
	...
	bvs	_runtimeErrorOverflow
	bne	_runtimeErrorWrongArraySize
!   Data Move: *_temp_616 = *_temp_623  (sizeInBytes=84)
	load	[r14+-32],r5
	load	[r14+-148],r4
	mov	21,r3
_Label_807:
...
!   _temp_629 = 4		(4 bytes)
	...
	store	r1,[r14+-24]
!   Initialize FOR-LOOP index variable
!   Data Move: j = _temp_628  (sizeInBytes=4)
	load	[r14+-28],r1
	store	r1,[r14+-200]
_Label_624:
!   Perform the FOR-LOOP termination test
!   if j > _temp_629 then goto _Label_627		
	load	[r14+-200],r1
	load	[r14+-24],r2
	cmp	r1,r2
	bvs	_runtimeErrorOverflow
...
!   _temp_630 = &condition
	...
	add	r1,4,r1
	store	r1,[r14+-20]
!   Move address of _temp_630 [j ] into _temp_631
!     make sure index expr is >= 0
	load	[r14+-200],r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
! SEND STATEMENT...
	...
	load	[r14+8],r1
	store	r1,[r14+-12]
!   if intIsZero (_temp_632) then goto _runtimeErrorNullPointer
	load	[r14+-12],r1
	cmp	r1,r0
	be	_runtimeErrorNullPointer
!   Send message PrintAllStatus
...
!     compute address of array element
	...
	add	r2,r1,r2
	store	r2,[r14+-48]
!   Data Move: *_temp_657 = 1  (sizeInBytes=4)
	mov	1,r1
	load	[r14+-48],r2
	store	r1,[r2]
! SEND STATEMENT...
...
!     compute address of array element
	...
	add	r2,r1,r2
	store	r2,[r14+-28]
!   Data Move: _temp_663 = *_temp_665  (sizeInBytes=4)
	load	[r14+-28],r1
	load	[r1],r1
	store	r1,[r14+-36]
!   if _temp_663 == 2 then goto _Label_662		(int)
	load	[r14+-36],r1
	mov	2,r2
	cmp	r1,r2
	be	_Label_662
...
!   _temp_691 = _temp_692 rem 5		(int)
	...
	bvs	_runtimeErrorOverflow
	store	r1,[r14+-76]
!   Move address of _temp_690 [_temp_691 ] into _temp_693
!     make sure index expr is >= 0
	load	[r14+-76],r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
!   Data Move: _temp_689 = *_temp_693  (sizeInBytes=4)
	...
	load	[r1],r1
	store	r1,[r14+-84]
!   if _temp_689 == 2 then goto _Label_686		(int)
	load	[r14+-84],r1
	mov	2,r2
	cmp	r1,r2
	be	_Label_686
...
!   _temp_696 = _temp_697 rem 5		(int)
	...
	bvs	_runtimeErrorOverflow
	store	r1,[r14+-56]
!   Move address of _temp_695 [_temp_696 ] into _temp_698
!     make sure index expr is >= 0
	load	[r14+-56],r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
!     compute address of array element
	...
	add	r2,r1,r2
	store	r2,[r14+-48]
!   Data Move: _temp_694 = *_temp_698  (sizeInBytes=4)
	load	[r14+-48],r1
	load	[r1],r1
	store	r1,[r14+-64]
!   if _temp_694 == 2 then goto _Label_686		(int)
	load	[r14+-64],r1
	mov	2,r2
	cmp	r1,r2
	be	_Label_686
...
!   Data Move: _temp_699 = *_temp_701  (sizeInBytes=4)
	...
	load	[r1],r1
	store	r1,[r14+-44]
!   if _temp_699 != 1 then goto _Label_686		(int)
	load	[r14+-44],r1
	mov	1,r2
	cmp	r1,r2
	bne	_Label_686
...
!   _temp_731 = &status
	...
	add	r1,88,r1
	store	r1,[r14+-48]
!   Move address of _temp_731 [p ] into _temp_732
!     make sure index expr is >= 0
	load	[r14+12],r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
!     compute address of array element
	...
	add	r2,r1,r2
	store	r2,[r14+-44]
!   Data Move: *_temp_732 = 3  (sizeInBytes=4)
	mov	3,r1
	load	[r14+-44],r2
	store	r1,[r2]
! SEND STATEMENT...
...
!   if intIsZero (_temp_739) then goto _runtimeErrorNullPointer
	...
	cmp	r1,r0
	be	_runtimeErrorNullPointer
!   Prepare Argument: offset=12  value=_temp_737  sizeInBytes=4
	load	[r14+-24],r1
	store	r1,[r15+4]
!   Send message Test
	load	[r14+-16],r1
...
!   _temp_760 = 4		(4 bytes)
	...
	store	r1,[r14+-36]
!   Initialize FOR-LOOP index variable
!   Data Move: p = _temp_759  (sizeInBytes=4)
	load	[r14+-40],r1
	store	r1,[r14+-44]
_Label_755:
!   Perform the FOR-LOOP termination test
!   if p > _temp_760 then goto _Label_758		
	load	[r14+-44],r1
	load	[r14+-36],r2
	cmp	r1,r2
	bvs	_runtimeErrorOverflow
...
!   _temp_767 = &status
	...
	add	r1,88,r1
	store	r1,[r14+-28]
!   Move address of _temp_767 [p ] into _temp_768
!     make sure index expr is >= 0
	load	[r14+-44],r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
!     compute address of array element
	...
	add	r2,r1,r2
	store	r2,[r14+-24]
!   Data Move: _temp_766 = *_temp_768  (sizeInBytes=4)
	load	[r14+-24],r1
	load	[r1],r1
	store	r1,[r14+-32]
